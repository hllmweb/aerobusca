...
// $todas_pag = $autenticacao->totalUsuarios()/10;
...
<head>
	<meta charset="utf-8">
	<title>Usuários | Leilões Freitas</title>
				...
				<div class="column-3x4">
					<div class="widget">
						...
						<div class="widget_body">
							...
							<div class="perfil">
								<div class="nome-perfil"><i class="fa fa-user"></i> Danilo Metzker</div>
								<div class="tipo-usuario">Pessoa física</div>
								<div class="data-cadastro">Cadastrado no dia 11/10/2016 às 12:23h</div>
							</div>
